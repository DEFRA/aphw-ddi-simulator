...
describe('/authorize GET controller: invalid request non-redirecting errors', () => {
  ...
  test('returns a Missing Parameters response for no query strings', async () => {
    const app = createApp()
  ...
  test('returns an Missing Parameters response for an no client_id', async () => {
    const app = createApp()
  ...
  test('returns an Missing Parameters response for no response_type', async () => {
    const app = createApp()
    const requestParams = createRequestParams({
  ...
  test('returns invalid request for a non-oidc prompt', async () => {
    const app = createApp()
    const requestParams = createRequestParams({
      client_id: knownClientId,
      response_type: 'code',
  ...
  test('returns an Missing Parameters response for a no redirect uri', async () => {
    const app = createApp()
    const requestParams = createRequestParams({
      client_id: knownClientId,
      response_type: 'code'
  ...
  test('returns an Missing Parameters response for a badly formatted redirect uri', async () => {
    const app = createApp()
    const requestParams = createRequestParams({
      client_id: knownClientId,
  ...
  test('returns an Invalid request response for non-matching redirect_uri', async () => {
    const app = createApp()
    const requestParams = createRequestParams({
      client_id: knownClientId,
  ...
  test('returns an Invalid request response for an unknown client_id', async () => {
    const app = createApp()
    const requestParams = createRequestParams({
...
describe('/authorize GET controller: Invalid request, redirecting errors', () => {
  ...
  test('redirects with an invalid request error response for no scope parameter', async () => {
    const app = createApp()
    const requestParams = createRequestParams({
      client_id: knownClientId,
      redirect_uri: knownRedirectUri,
  ...
  test('redirects with an invalid request error for a scope which does not include openid ', async () => {
    const app = createApp()
    const requestParams = createRequestParams({
      client_id: knownClientId,
      redirect_uri: knownRedirectUri,
  ...
  test('returns 302 and redirects with an error for invalid JSON in claims', async () => {
    const app = createApp()
    const requestParams = createRequestParams({
      client_id: knownClientId,
      redirect_uri: knownRedirectUri,
  ...
  test('returns 302 and redirects with an error for unknown prompt', async () => {
    const app = createApp()
    const requestParams = createRequestParams({
      client_id: knownClientId,
      redirect_uri: knownRedirectUri,
  ...
  test('returns 302 and redirects with an error for no state', async () => {
    const app = createApp()
    const requestParams = createRequestParams({
      client_id: knownClientId,
      redirect_uri: knownRedirectUri,
  ...
  test('returns 302 and redirects if the request includes a request_uri', async () => {
  ...
  test('returns 302 and redirects if the response_type is not code', async () => {
    const state = 'a7e4bfd39d3eaa57c27775744f22c5a2'
    const app = createApp()
    const requestParams = createRequestParams({
      client_id: knownClientId,
  ...
  test('returns 302 and redirects with an error for invalid scope', async () => {
    const state = 'a7e4bfd39d3eaa57c27775744f22c5a2'
    const app = createApp()
    const requestParams = createRequestParams({
      client_id: knownClientId,
  ...
  test('returns 302 and redirects with an error for unsupported scope', async () => {
    const state = 'a7e4bfd39d3eaa57c27775744f22c5a2'
    const app = createApp()
    const requestParams = createRequestParams({
      client_id: knownClientId,
  ...
  test('returns 302 and redirects with an error for unknown claim', async () => {
    const state = 'a7e4bfd39d3eaa57c27775744f22c5a2'
    const app = createApp()
    const requestParams = createRequestParams({
      client_id: knownClientId,
  ...
  test('returns 302 and redirects with an error for an unsupported claim', async () => {
    const state = 'a7e4bfd39d3eaa57c27775744f22c5a2'
    const app = createApp()
    const requestParams = createRequestParams({
      client_id: knownClientId,
  ...
  test('returns 302 and redirects with an error for no nonce value', async () => {
    const state = 'a7e4bfd39d3eaa57c27775744f22c5a2'
    const app = createApp()
    const requestParams = createRequestParams({
      client_id: knownClientId,
  ...
  test.each(['[]]', '["Ch"]', '["Cl.P2"]', '["Cl.Cm.P2","Cl.Cm"]'])(
...
describe('valid auth request', () => {
  ...
  test('returns 302 and redirects with an access_denied error when the client has enabled ACCESS_DENIED', async () => {
    jest
  ...
  test('returns 302 and redirect with an auth code for a valid minimal auth request', async () => {
    const state = 'a7e4bfd39d3eaa57c27775744f22c5a2'
    const nonce = '3eb5b04ca8e1baf7dea15b7fb7ac05a6'
    const app = createApp()
    const requestParams = createRequestParams({
  ...
  test('returns 302 and redirect with an auth code for a valid auth request with claims', async () => {
    const state = 'a7e4bfd39d3eaa57c27775744f22c5a2'
    const nonce = '3eb5b04ca8e1baf7dea15b7fb7ac05a6'
    const app = createApp()
    const requestParams = createRequestParams({
  ...
  test('returns 302 and redirect with an auth code for a valid auth request with claims and prompt', async () => {
    const state = 'a7e4bfd39d3eaa57c27775744f22c5a2'
    const nonce = '3eb5b04ca8e1baf7dea15b7fb7ac05a6'
    const app = createApp()
    const requestParams = createRequestParams({
  ...
  test('returns 302 and redirect with an auth code for a valid auth request with claims, prompt and valid vtr', async () => {
    const state = 'a7e4bfd39d3eaa57c27775744f22c5a2'
    const nonce = '3eb5b04ca8e1baf7dea15b7fb7ac05a6'
    const app = createApp()
    const requestParams = createRequestParams({
