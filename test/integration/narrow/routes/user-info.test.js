...
const { EC_PRIVATE_TOKEN_SIGNING_KEY } = require('../../../../app/constants')
...
const EXAMPLE_RETURN_CODE = [{ code: 'example_code' }]

describe('/userinfo endpoint', () => {
  test('returns an error for missing header', async () => {
  ...
  test('returns a invalid_token error for badly formed header', async () => {
    await setupClientConfig(
      KNOWN_CLIENT_ID,
      ['openid', 'email', 'phone'],
      false
  ...
  test('returns an invalid_token response for a header without Bearer ', async () => {
  ...
  test('returns an invalid_scope error for invalid scope', async () => {
    await setupClientConfig(
      KNOWN_CLIENT_ID,
      ['openid', 'email', 'phone'],
      false
  ...
  test('returns an invalid_scope error for unexpected scope', async () => {
  ...
  test('returns an invalid_token error for missing client id', async () => {
    await setupClientConfig(
      KNOWN_CLIENT_ID,
      ['openid', 'email', 'phone'],
      false
  ...
  test('returns an invalid_token error for unexpected client id', async () => {
    await setupClientConfig(
      KNOWN_CLIENT_ID,
      ['openid', 'email', 'phone'],
      false
  ...
  test('returns an invalid_token error for expired token', async () => {
    await setupClientConfig(
      KNOWN_CLIENT_ID,
      ['openid', 'email', 'phone'],
      false
  ...
  test('returns an invalid_token error for invalid signature', async () => {
    await setupClientConfig(
      KNOWN_CLIENT_ID,
      ['openid', 'email', 'phone'],
      false
  ...
  test('returns an invalid_token error for unexpected issuer', async () => {
    await setupClientConfig(
      KNOWN_CLIENT_ID,
      ['openid', 'email', 'phone'],
      false
  ...
  test('returns an invalid token error if the access token is not in the accessToken store', async () => {
    await setupClientConfig(KNOWN_CLIENT_ID, ['openid', 'email', 'phone'])
    const accessToken = await createAccessToken(
      ISSUER_VALUE,
      KNOWN_CLIENT_ID,
  ...
  test('returns expected user info for valid token', async () => {
    await setupClientConfig(
      KNOWN_CLIENT_ID,
      ['openid', 'email', 'phone'],
      false
  ...
  test('returns an invalid token error if the access does not match the one in the access token store', async () => {
    await setupClientConfig(KNOWN_CLIENT_ID, ['openid', 'email', 'phone'])
...
describe('/userinfo endpoint with identity verification enabled', () => {
  test('returns an invalid_request error for a request with an unsupported claim', async () => {
    await setupClientConfig(
      KNOWN_CLIENT_ID,
      ['openid', 'email', 'phone'],
      true,
  ...
  test('returns expected user info for valid token with null claims', async () => {
    await setupClientConfig(KNOWN_CLIENT_ID, ['openid', 'email', 'phone'])
    const accessToken = await createAccessToken(
      ISSUER_VALUE,
      KNOWN_CLIENT_ID,
  ...
  test('returns expected user info for valid token with supported claims', async () => {
    await setupClientConfig(
      KNOWN_CLIENT_ID,
      ['openid', 'email', 'phone'],
      true,
  ...
  test('for scenario INVALID_ALG_HEADER: returns coreIdentityJWT with incorrect header alg', async () => {
    await setupClientConfig(
      KNOWN_CLIENT_ID,
      ['openid', 'email', 'phone'],
      true,
  ...
  test('for scenario INVALID_SIGNATURE: returns coreIdentityJWT with invalid signature', async () => {
    await setupClientConfig(
      KNOWN_CLIENT_ID,
      ['openid', 'email', 'phone'],
      true,
  ...
  test('for scenario INVALID_ISS: returns coreIdentityJWT with invalid iss', async () => {
    await setupClientConfig(
      KNOWN_CLIENT_ID,
      ['openid', 'email', 'phone'],
      true,
  ...
  test('for scenario INVALID_AUD: returns coreIdentityJWT with invalid aud', async () => {
    await setupClientConfig(
      KNOWN_CLIENT_ID,
      ['openid', 'email', 'phone'],
      true,
  ...
  test('for scenario INCORRECT_SUB: returns coreIdentityJWT with incorrect sub', async () => {
    await setupClientConfig(
      KNOWN_CLIENT_ID,
      ['openid', 'email', 'phone'],
      true,
  ...
  test('for scenario TOKEN_EXPIRED: returns coreIdentityJWT with exp in past', async () => {
    await setupClientConfig(
      KNOWN_CLIENT_ID,
      ['openid', 'email', 'phone'],
      true,
