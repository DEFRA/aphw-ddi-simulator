...
const { vtrValidator } = require('../../../../app/validators/vtr-validator')
...
describe('vtrValidator tests', () => {
  ...
  test('returns the default credential trust and level of confidence when vtr is undefined', () => {
  ...
  test('throws an error when a vtr includes more than 1 identity component', () => {
    levelOfConfidenceSpy.mockReturnValue(['P0', 'P2'])
  ...
  test('ignores any unknown values', () => {
    levelOfConfidenceSpy.mockReturnValue(['P0', 'P2'])
  ...
  test('throws an error when a vtr includes an unsupported credential trust value', () => {
    levelOfConfidenceSpy.mockReturnValue(['P0', 'P2'])
  ...
  test('throws an error when a vtr includes an invalid level of identity confidence', () => {
    levelOfConfidenceSpy.mockReturnValue(['P0', 'P2'])
  ...
  test('throws an error when a vtr specified P2 confidence with an credential trust value of Cl', () => {
    levelOfConfidenceSpy.mockReturnValue(['P0', 'P2'])
  ...
  test('throws an error when a vtr specified P1 confidence with an credential trust value of Cl', () => {
  ...
  test('throws an error when a vtr set includes both identity and non identity components', () => {
    levelOfConfidenceSpy.mockReturnValue(['P0', 'P2'])
  ...
  test('throws an error when a vtr set includes levels of identity confidence not supported by the client', () => {
  ...
  test('throws an error when a vtr set is an invalid JSON array', () => {
    levelOfConfidenceSpy.mockReturnValue(['P0', 'P2'])
  ...
  test('does not allow both identity and non-identity components in the vtr with a P0', () => {
    levelOfConfidenceSpy.mockReturnValue(['P0', 'P2'])
  ...
  test('does not allow both identity and non-identity implicitly', () => {
    levelOfConfidenceSpy.mockReturnValue(['P0', 'P2'])
  ...
  test('returns a parsed valid vtr set', () => {
  ...
  test('allows P0 with any credential trust level', () => {
  ...
  test('handles an omitted LOC but any credential trust', () => {
    levelOfConfidenceSpy.mockReturnValue(['P0'])
